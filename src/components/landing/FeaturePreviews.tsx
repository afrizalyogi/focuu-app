...
const FeaturePreviews = () => {
  ...
  const features = [
    ...
    },
    {
      id: "analytics",
      icon: BarChart3,
      title: "Detailed Growth Analytics",
      description: "Track daily, weekly, and monthly growth trends.",
    ...
    <div className="animate-fade-in">
      ...
      <div className="flex gap-4 justify-center">
        {themes.map((theme) => (
          ...
          >
            <div
              className={`w-8 h-1 rounded-full ${theme.name === "Light" ? "bg-black/20" : theme.name === "Book" ? "bg-[#2c2417]/20" : "bg-white/20"}`}
            />
            <div
              className={`w-6 h-1 rounded-full ${theme.name === "Light" ? "bg-black/20" : theme.name === "Book" ? "bg-[#2c2417]/20" : "bg-white/20"}`}
            />
