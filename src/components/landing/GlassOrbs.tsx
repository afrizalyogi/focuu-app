  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, hsl(280 100% 70% / 0.1) 0%, transparent 70%)",
          filter: "blur(40px)",
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, hsl(142 71% 45% / 0.08) 0%, transparent 70%)",
          filter: "blur(50px)",
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, transparent 0%, hsl(var(--background) / 0.3) 100%)",
        }}
      />
